...
def new_order(self, symbol: str, side: str, type: str, timestamp: str, **kwargs):
    """
    |
    | **New Order (TRADE)**
    | *Send a new order*
    ...
    check_required_parameters([[symbol, "symbol"], [side, "side"], [type, "type"],[timestamp, "timestamp"]])
    params = {"symbol": symbol, "side": side, "type": type, "timestamp": timestamp, **kwargs}
